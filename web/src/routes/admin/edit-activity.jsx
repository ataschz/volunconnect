...
export default function EditActivityRoute() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      number_of_volunteers: state.number_of_volunteers,
      end_date: state.end_date.toDate(),
      start_date: state.start_date.toDate(),
      address_formatted: state.address_formatted,
      address_geopoint: state.address_geopoint,
      lat: state.address_geopoint._lat,
      lng: state.address_geopoint._long,
  ...
  const onSubmit = async (values) => {
    try {
      await updateDoc(doc(db, "activities", activity_id), {
        name: values.name,
        ...
        address_geopoint: new GeoPoint(values.lat, values.lng),
        organization: orgId,
      });
    ...
    <div className="flex flex-col gap-6">
      ...
      <Form {...form}>
        ...
        >
          ...
          <DeleteDialog activityId={activity_id}>
